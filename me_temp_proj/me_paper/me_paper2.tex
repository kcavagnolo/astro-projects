...
% \citep{2006ApJ...639...64O, 2006ApJ...650..128K}. 
...
%\end{equation}
%[MAYBE FOR AN APPENDIX BUT NOT THE MAIN part of the PAPER.]
...
ARE $ R_{5000}$???). 
%This variety of extraction
%radii also allows us to assess the sensitivity of temperature
%measurement to aperture size. HUH-skip this, XMM does this better I'd think.
% so who cares.
...
%necessary when the F-statistic was less than 0.05. [NOT SURE IF THIS TEST
%IS VALID IN THIS SITUATION.] We found fixing
...
%I think we can cut to the chase MUCH faster.
...
\tablehead{
\colhead{Aperture} & 
\colhead{[0.7-7.0]} & \colhead{[2.0$_{rest}$-7.0]} & \colhead{$\tf$} & 
\colhead{[0.7-7.0]} & \colhead{[2.0$_{rest}$-7.0]} & \colhead{$\tf$}\\
...
\enddata
\tablecomments{Note: '77' refers to 0.7-7.0 keV band, '27' refers to 2.0$_{rest}$-7.0 keV band. (1) Cluster name, (2) absorbing, Galactic neutral hydrogen column density, (3,4) best-fit MeKaL temperatures, (5) best-fit 77 MeKaL abundance, (6) $\tf$, (7,8) reduced $\chi^2$ statistics, (9) percent of emission attributable to source. $\dagger$ indicates cluster with multiple independent, simultaneously fit spectra.}
\end{deluxetable}
