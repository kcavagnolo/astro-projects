...
; ymodel the I value
; calling syntax: result = calc_sz(x, params)
...
gam1 = gamma(3.0d0 * this_beta / 2.0d0 + this_delta - 0.5d0)
gam2 = gamma(3.0d0 * this_beta / 2.0d0 + this_delta)
...
if ( this_rc GT this_alpha * this_r500 ) then begin
   ...
   for I = 0, num_points-1 do begin
      ...
      a = float(3.0 * this_beta / 2.0)
      b = 0.5
      c = float(3.0 * this_beta / 2.0 + this_delta)
