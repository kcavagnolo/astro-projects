...
#     This is going to be a bit of a hack. Going to get rid of 
#     the arfgen, rmfgen i.e. set them both to zero. Instead, 
#     I am going to use evigweight to account for vignetting. 
#     Canned arf / rmffiles are going to be used instead. 
...
evigweight -w 0 -V 0 ineventset=$ev newoutput=yes outeventset=tempEv00
evselect -w 0 -V 0 table=tempEv00 filteredset=tempEv01 expression="$patexp" updateexposure=N writedss=Y withfilteredset=Y destruct=Y keepfilteroutput=T
...
evigweight -w 0 -V 0 ineventset=$bg newoutput=yes outeventset=tempEv00
evselect -w 0 -V 0 table=tempEv00 filteredset=tempEv02 expression="$patexp" updateexposure=N writedss=Y withfilteredset=Y destruct=Y keepfilteroutput=T
