...
extern "C" void monohydrostatic (const EnergyPointer& energyArray,
				 ...
				 const string& modName)
{
  ...
  static const string CLMASS ("MonotonicMass");
  ...
  try {
	...
	m->mixingComponents (CLMASS, new MonoClusterMassModel (CLMASS));
      }
