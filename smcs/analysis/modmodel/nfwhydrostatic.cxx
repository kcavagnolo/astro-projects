...
extern "C" void nfwhydrostatic (const EnergyPointer& energyArray,
				...
				const string& modName)
{
  ...
  static const string CLMASS ("NFWPotential");
  ...
  try {
	...
	m->mixingComponents (CLMASS, new NFWClusterMassModel (CLMASS));
      }
