pro sersic_fit,rad,a,f
;-----------------------------------------------------------------------
;
; Name: SERSIC_FIT
;
; Purpose: Fits a sersic profile to data
;
; Inputs: NONE
;
...
;
   a = [I0,scl]
   w = 1/int
   yfit=curvefit(rad,int,w,a,sigma,function_name='sersic_fit',/noderivative)
