...
\begin{abstract}
  Using a $50$ kilosecond Chandra X-ray Observatory image, we present
  a analysis of the hot intracluster medium (ICM) and cavity system in
  the galaxy cluster RBS 797. In addition to the two previously known
  cavities in the cluster core, the new and deeper image has revealed
  additional structure associated with the AGN. The surface
  brightness decrements of the two cavities are unusually large, and
  are consistent with elongated cavities lying along our
  line-of-sight. We estimate a total AGN outburst energy and mean jet
  power of $\approx 1-3 \times 10^{60}$ erg and $\approx 1-3 \times
  10^{45} ~\lum$, respectively, depending on the assumed geometrical
  configuration of the cavities. Thus, RBS 797 is apparently among
  the the most powerful AGN outbursts known in a cluster. The average
  mass accretion rate needed power the AGN by accretion alone is $\sim
  1 ~\msolpy$. We show that accretion of cold gas onto the AGN at
  this level is plausible, but that Bondi accretion of the hot
  atmosphere is probably not. The BCG harbours an unresolved,
  non-thermal nuclear X-ray source with a luminosity of $\lbol = 2.3
  \times 10^{44} ~\lum$. The nuclear emission is probably associated
  with a rapidly-accreting, radiatively inefficient accretion flow.
  We present tentative evidence that star formation in the BCG is
  being triggered by the radio jets.
\end{abstract}
...
galaxies and supermassive black holes (SMBHs) are coupled. This
coupling may be governed by energetic feedback from active galactic
nuclei (AGN) which regulates the growth of galaxies and their SMBHs
\citep[\eg][]{1995ARA&A..33..581K, 1998A&A...331L...1S,
  2000MNRAS.311..576K, 2002ApJ...574..740T}. The discovery of AGN
induced cavities associated with cooling hot halos of massive galaxies
and clusters has strengthened this idea \citep[see][for
  reviews]{mcnamrev, Peterson \& Fabian 2006} by revealing that AGN
mechanical heating is capable of regulating the radiative cooling of
hot halos \citep[\eg][]{birzan04, dunn06, rafferty06}. {\bf Ken need
  to add Peterson & Fabian 06 reference}

Models of AGN feedback in the so-called ``radio mode'' posit that
cooling gas from a galaxy's hot halo accretes onto the central SMBH,
driving AGN activity that eventually offsets cooling in a thermally
regulated feedback loop \citep[\eg][]{croton06, bower06, sijacki07,
  McNamara \& Nulsen 2007}. While there is direct evidence that halo
cooling and feedback are linked \citep[\eg][]{haradent, rafferty08},
the observational constraints on how AGN are fueled and powered are
more difficult to establish. Gas accretion alone can, in principle,
fuel most AGN \citep[\eg][]{pizzolato05, 2006MNRAS.372...21A}.
\citep[\eg][]{rafferty06}. However, for some relatively gas-poor
systems hosting the energetic AGN exceeding $10^{61}$ erg (eg.,
Hercules A, Hydra A, \ms\ , 3C444 {\bf Ken the reference to 3C444
  is \bibitem[Croston et al.(2010)]{2010arXiv1011.6405C} Croston,
  J.~H., Hardcastle, M.~J., Mingo, B., Evans, D.~A., Dicken, D.,
  Morganti, R., \& Tadhunter, C.~N.\ 2010, arXiv:1011.6405 which we
  should include} it has been pointed out that gas accretion alone may
have difficulty sustaining their AGN unless accretion is unusually
efficient. This problem has lead to speculation that some BCGs may
host ultramassive black holes \citep[$> 10^{10} ~\msol$;
  \eg][]{msspin}, or that some AGN are powered by the release of
energy stored in rapidly-spinning SMBH \citep[\eg][]{minaspin}. In
this paper, we explore these and other issues through an analysis of
the powerful AGN outburst in the the RBS 797 cluster.
