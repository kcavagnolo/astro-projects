...
# X_table contains the source positions, with the field center rotated to zero RADEC
  ...
  if ( ( dojac != None ) or ( beam_offset_model == None ) or ( beam_parameters == None ) or 
      ( rp_table == None ) or ( gain_zero_table == None ) or ( amplitude_table == None ) or 
      ( error_table == None ) or ( normalize_weights == None ) ):
    return - 1, None, None
