...
pro chandra_acis_s_bg,segrid,sb,iegrid,ib

;
; Sebastian Heinz, 02/26/2009
;
; Return skybackground and instrumental background for ACIS-S, based on energy
; grid, using blank sky background file
;
; Treat background entirely as instrumental (taken from raw detector data)
;

restore,'$XIMPATH/chandra_acis_s_bg.dat'    
