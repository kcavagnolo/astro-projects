...
\begin{abstract}
  ...
  when the ratio of lobe energy in non-radiating particles to that in
  relativistic electrons is $\ga 100$. We identify a sub-set of gEs
  with unusually large radio luminosities for their jet powers. For
  this gE sub-set, the radio sources extend well beyond the densest
  parts of their X-ray halos, and we suggest these systems are
  unusually luminous because they did not entrain appreciable amounts
  of gas from their environments.
\end{abstract} 
...
mechanical energy in the cavities greatly exceeds the synchrotron
power of the radio source, we assume that $\pcav = \pjet$. Further,
\pcav\ does not include energy channeled into shocks, which can exceed
...
assuming that the uncertainties in ambient pressure, cavity volume,
and cavity age are independent of one another.
