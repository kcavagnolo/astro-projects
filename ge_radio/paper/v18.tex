...
\begin{abstract}
  ...
  relativistic electrons is $\ga 100$. Focusing on a sub-set of gEs
  with what we suspect are poorly confined radio sources, we discuss
  the importance of environment when measuring a
