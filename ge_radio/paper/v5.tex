...
\citet{mcnamrev} for discussion of how timescales are
...
monochromatic radio power for each source using the relation $\pnu = 4
\pi D_L^2 (1+z)^{-1} S_{\nu} f_0$ where $S_{\nu}$ is the NVSS or SUMSS
flux, $D_L$ is the luminosity distance, and $f_0$ is the central beam
