...
#
# Get path to CASA home directory by stipping name from '$AIPSPATH'
...
if not benchmarking:
    ...
    print >>logfile,'*   fluxscale    time was: '+str(fstime-gaintime)
    ...
    print >>logfile,'*   clean        time was: '+str(cleantime-contsubtime)
    print >>logfile,'*****************************************'
