...
namespace parammm
{
  ...
  void pint_opt::setfromstream(std::istrstream *str) const
  {
    *str >> *m_p;
  }
  ...
  void pbool_noopt::setfromstream(std::istrstream *str) const
  {
    *m_p = true;
  }
  ...
  void pbool_opt::setfromstream(std::istrstream *str) const
  {
    char c;
    *str >> c;
    switch(c) {
  ...
  void pstring_opt::setfromstream(std::istrstream *str) const
  {
  ...
  void pchar_opt::setfromstream(std::istrstream *str) const
  {
    string s;
  ...
  void pdouble_opt::setfromstream(std::istrstream *str) const
  {
    *str >> *m_p;
  }
  ...
  void pcallback_noopt::setfromstream(std::istrstream *str) const
  {
  ...
  void pcallback_opt::setfromstream(std::istrstream *str) const
  {
    string param;
