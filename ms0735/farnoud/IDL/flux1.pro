pro flux, imname,outfile,lumdist,rad, m0

Dl = lumdist	; luminosity distance (Mpc)
D = double (Dl * 3.0856E24) ; luminosity distance (cm)
lambda = 21590 ; central wavelength of filter used (angstroms)
...
f0 = 4.29E-11
	...
	printf,1,'; 7. Flux Error (ergs/cm^2/s)'
	printf,1,'; 8. Luminosity (ergs/s)'
	printf,1,'; 9. Luminosity Error (ergs/s)'
	printf,1
	close,1	
...
for i = 1, rad, 1 do begin
	...
	lumerr = lum * error
	openw, 1, outfile, /append
	printf, 1,i,total,totalerr,apmag,apmagerr,flux,fluxerr,lum,lumerr
	close, 1
endfor
