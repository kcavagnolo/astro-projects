...
readcol, 'GCs_5128', rah,ram,ras,decd,decm,decs
...
set_plot, 'x'
set_plot, 'ps'
device, filename='GCs.ps',/color
loadct, 13

!P.color=0
plot, ra,dec,psym=2,symsize=0.5,xtitle='DEC', ytitle='RA',xrange=[202.6,200.14],yrange=[-43.74,-42.32], /xstyle, /ystyle
legend, 'Known GCs', pos=[200.75,-42.4], box=0
...
!P.color=255
legend, 'Matched GCs', pos =[200.75,-42.5],box=0
