...
;set_plot,'x'
;set_plot,'ps'
;device, filename='ms07sbser.eps', /encapsulated, /times, /color, xs=12, ys=11
;loadct, 13
...
ymax = max(mag)+1
ymin = min(mag)-2
plot, rad, mag, psym=symcat(9), /xlog, yrange=[ymax,ymin], symsize=0.5, ytitle='!4l!6!DI,o!N (mag arcsec!E-2!N)',  xtitle='!6Radius (arcsec)', /ystyle
