...
;========================================================================
;;;
;;; Dataset_3D Widget: $Id: dataset_3d.pro,v 1.2 2008-10-15 19:35:51 cavagnolo Exp $
;;;
      ...
      if (pathname NE '') then begin
       ...
       if (Error NE 0) then begin
         ...
         plot_window, (*st).pw_id, XAXIS=xaxis, YAXIS=yaxis, ZAXIS=zaxis
           ...
           sxaddpar, fits_header, "CREATOR", "$RCSfile: dataset_3d.pro,v $, Version $Revision: 1.2 $"
    ...
    3: $ ; SAVE DATASET
     ...
     if (pathname NE '') then begin
       ...
       if (Error NE 0) then begin
         ...
         sxaddpar, pheader, "CREATOR", "$RCSfile: dataset_3d.pro,v $, Version $Revision: 1.2 $"
