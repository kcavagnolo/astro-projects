...
;==========================================================================
;;;
;;; FILE NAME:    $Id: acis_grade_filter.pro,v 1.2 2008-10-15 19:35:50 cavagnolo Exp $
;;;
...
case event.id of
  ...
  state.default1_button: $
    begin
    state.entry_list.status = 0
    state.entry_list[[0, 2, 8, 16, 64]].status = 1
    filter_revised = 1
    end
  ...
  state.default2_button: $
    begin
    state.entry_list.status = 0
    state.entry_list[[0,2,8,16,64,80,18,10,72,208,22,11,104]].status = 1
    filter_revised = 1
    end
...
top_base = widget_base( UVALUE=uvalue, TITLE=title, GROUP=group, /COLUMN, $
 ...
 default1_button = widget_button( top_base, VALUE='Singles (ACIS 0,2,8,16,64)' )

 default2_button = widget_button( top_base, VALUE='Singles, ells (ACIS 0,2,8,16,64,80,18,10,72,208,22,11,104)' )
...
state = { $
	...
	default1_button:default1_button, default2_button:default2_button, $
