...
;==========================================================================
;;;
;;; FILE NAME:    $Id: eb_manager.pro,v 1.2 2008-10-15 19:35:51 cavagnolo Exp $
;;;
...
case event.id of
  ...
  state.top_base: $
	...
	if (count NE 0) AND (event.filename NE '') then begin
...
;print, 'widget_event() RETURNED'     
  ...
  state.about_button: $
    begin
    str=['Event Browser, version $Revision: 1.2 $','',$
...
AddPrimaryKywd, "HISTORY", BEFORE='FITSVERS', $
		   "written by Event Browser, version $Revision: 1.2 $, " + systime()
