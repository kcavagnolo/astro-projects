...
print,' '
cmdstring=ciao_root+'/ots/saord/ds9 '+evt2file+' -scale sqrt -cmap b'
spawn,cmdstring,result
print,' '
...
cmdstring='dmcopy "'+evt2file+'[ccd_id='+strtrim(string(chipid),2)+']" ./reprocessed/evt2_ccd.fits'
...
cmdstring=ciao_root+'/ots/saord/ds9 ./background/ccd_img.fits -regionfile ./regions/ccd_src.reg -scale sqrt -cmap b'
spawn,cmdstring,result
print,'...done.'
...
cmdstring=ciao_root+'/ots/saord/ds9 ./background/ccd_img.fits -scale sqrt -cmap b'
spawn,cmdstring,result
