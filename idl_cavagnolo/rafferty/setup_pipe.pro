...
print,' '
print,' If you dont know the chip ID, use the BIN menu to bin out'
...
print,' '  
print,' Exit ds9 when youre done.'
print,' '
...
read,chipid,prompt=' Enter the chip number you wish to analyse: (0-9) '
answer_check:
...
print,' When youre done, exit ds9.'
...
; Run the pipeline
;
acis_reprocess,chipid,/newbpix
extract_annuli,xc,yc,mincnts,/mkacisrmf,chipid=chipid,ellip=e,pa=posang,cencnts=centercnts
