; $Id: annotate2.pro,v 1.1.1.1 2007-02-03 17:10:50 cavagnolo Exp $
;
...
for i=0, n_elements(id)-4 do $		;Set up uv = Mn
...
PRO ANNOTATE2, DRAWABLE = draw, WINDOW = window, LOAD_FILE=load_file, $
	COLOR_INDICES=color_indices, TEK_COLORS = tek_colors

;+
; NAME:
;	ANNOTATE2 - Slightly revised version of ANNOTATE designed to
;                   work within TCTOOL.
;
; PURPOSE:
...
;
;       This TCTOOL version is stripped down to just text, lines and arrows.
;
; CATEGORY:
