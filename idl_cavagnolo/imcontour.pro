...
;               to account for edge effects in the image display.   By default,
;               OVERLAY is set if /NOERASE is set.
;
...
; ratio as the image
  ...
  if N_elements(overlay) EQ 0 then overlay = keyword_set(noerase)
