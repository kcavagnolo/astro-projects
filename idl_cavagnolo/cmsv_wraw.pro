...
;
; $Id: cmsv_wraw.pro,v 1.2 2009-06-19 22:21:48 cavagnolo Exp $
;
;-
; Copyright (C) 2000-2001, 2006, Craig Markwardt
...
pro cmsv_wraw, block, pointer, value0, unit=unit, replen=replen, $
  ...
  if tp EQ 7 then begin   ;; STRING DATA
      ...
      for i = 0L, n_elements(value0)-1 do begin
          ...
          if replen1 AND hlen GT 0 then block(pointer+4) = byte(hlen, 0, 4)
          pointer = pointer + stride + stride*replen1*(hlen GT 0)
