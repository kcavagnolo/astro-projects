...
;       V0.1: Exported the functions ADDSIGNAL and ADD_NOISE to make WVT_BINNING 
;           more flexible (11/2004)
...
PRO WVT_IMAGE, signal, noise, targetSN, binnedimage, xnode, ynode, weight, $
  ...
  ; and passes everything on to WVT_BINNING.
  ; This was designed particularly with X-ray images in mind. The structure P will 
  ; hold all information about the individual pixels (signal, noise, cts, ...)
  COMMON DATAVALUES, P
