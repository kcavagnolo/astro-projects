...
;       WVT_PIXELLIST provides an interface to directly use pixel lists, similar
;       to the code VORONOI_2D_BINNING (Cappellari & Copin, 2003), which this 
...
;
; FUNCTIONS PROVIDED:
;       The following functions are contained in the main WVT_PIXELLIST program.
;       Refer to the main code for further explanations.
