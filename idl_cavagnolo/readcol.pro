pro readcol,name,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15, $
            ...
            COMMENT = comment, FORMAT = fmt, DEBUG=debug, SILENT=silent, $
            SKIPLINE = skipline, NUMLINE = numline, DELIMITER = delimiter, $
            NAN = NaN, PRESERVE_NULL = preserve_null
;+
; NAME:
;       READCOL
; PURPOSE:
...
;
; CALLING SEQUENCE:
;       READCOL, name, v1, [ v2, v3, v4, v5, ...  v45 , COMMENT=, /NAN
