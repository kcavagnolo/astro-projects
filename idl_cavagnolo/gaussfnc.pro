...
;
;    X     (REQ) (I) (0 1) (I L F D)
;          required scalar or vector containing the independent
;          variable(s)
;
;    X0    (REQ) (I) (0)   (F D)
...
;
;    DX    (REQ) (I) (0)   (F D)
;          required scalar giving the one sigma width of the
;          distribution
;          This parameter must have the same units as X.
;
;    YMAX  (REQ) (I) (0)   (F D)
...
; 
;    Y     (REQ) (O) (0 1) (F D)
;          required output scalar or vector giving the calculated
;          value
...
;*EXAMPLES:
;
;    To calculate a gaussian with center at 1545 A, sigma of 2 A,
;    using the
;    wavelength scale derived from an IUE spectrum, with amplitude
;    1.0,
; 
...
;    Sep 25 1984  RWT GSFC  changed limit from 12 sigma to 9 sigma due
;    to
...
;    Jun 25 1991  PJL GSFC  cleaned up; lowercase; tested on SUN and
;    VAX;
;    updated prolog
;
;-
;***********************************************************************
 pro gaussfnc,x,x0,dx,ymax,y
;
 npar = n_params(0)
