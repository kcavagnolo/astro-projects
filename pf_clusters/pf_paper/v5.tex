...
\usepackage[pagebackref,
  pdftitle={INTRACLUSTER MEDIUM ENTROPY PROFILES FOR A CHANDRA
...
\altaffiltext{2}{University of Waterloo, Department of Physics and
  Astronomy, Waterloo, ON, N2L 2G1; kcavagnolo@astro.waterloo.ca}
...
%% After extracting data values for $K(r)$ from Figure 1 in
%% \citep{2003A&A...408....1P} using DEXTER \citep{dexter}, we fit the
%% entropy profile with our simple model and found $\kna 62.7 \pm 9.9
%% \ent$. It is worth noting that A1983 falls in the bimodal gap shown in
%% Fig. \ref{fig:k0hist}. Of additional interest is that like most other
%% clusters in that \kna\ region, there is nothing extraordinary about
%% A1983: no detected \halpha\ emission, no radio-loud AGN, no obvious
%% X-ray substructure, and no distinguishing optical or infrared
%% characteristics.
...
%% NB: add error in mean to the numbers below
