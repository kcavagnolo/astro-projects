...
pro flux, dat1, dat2, nmc
; flux, '1tpr_nhfrozen_fefree.dat', 'reference_all.list', 1000
...
; define the filename for the radial profile
    filename = '../radprofs/10pixs/'+clustername+'_'+obs+'_'+chip+'_radprof_10pix_norm.fits'
...
; retrieve the exposure time from the header
    ...
    sbr = sbr[0]/10^(-11.)
    sbr_err = sbr_err[0]/10^(-12.)

    openw,1,'flux'+strcompress(clustername,/remove_all)+'.dat'
