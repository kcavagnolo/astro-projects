...
\begin{abstract}
  Using a deep \chandra\ X-ray observation, we present a detailed
  study of the ultraluminous infrared brightest cluster galaxy \inine,
  ...
  ~\lum$ jets from the buried quasar (QSO) in \inine, and excess X-ray
  emission near the core which is well-modeled as illumination of the
  ICM and cold gas by $\sim 10^{47}$ erg QSO radiation. We also show
  that the properties of the \inine\ nucleus are consistent with
  reflected emission from an AGN embedded in a moderately
  Compton-thick medium. From these results, we suggest \inine\ may be
  a local example of how higher-redshift galaxies transition from a
...
%% $\mbh = 0.63 ~(\pm 0.05) \times 10^9 ~\msol$.
