...
\author[Cavagnolo et al.]{
  \parbox[t]{\textwidth}{
    K. W. Cavagnolo,$^{1}$\thanks{Email:cavagnolo@oca.eu}
    M. Donahue,$^{2}$
    G. M. Voit,$^{2}$
    B. R. McNamara,$^{3,4,5}$
    and M. Sun$^{6}$}\\\\
  $^{1}$Observatoire de la C\^{o}te d'Azur, UNS, CNRS UMR 6202 Cassiop\'{e}e, Nice, France.\\
  $^{2}$Michigan State University, Department of Physics and Astronomy, East Lansing, MI, USA.\\
  $^{3}$University of Waterloo, Department of Physics and Astronomy, Waterloo, ON, Canada.\\
